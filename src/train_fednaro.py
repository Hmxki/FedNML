...
from update_fednaro import LocalUpdate, test_inference
...
from src import models_vit as models
...
if __name__ == '__main__':
    ...
    log_file = os.path.join("../output_print/brazilian", "4-6-classbacc-fednaro.txt")
    ...
    if args.model == 'cnn':
        ...
        global_model = models.__dict__[args.model](
            img_size=256,
            num_classes=20,
            drop_path_rate=0.2,
            global_pool=True,
        ...
        checkpoint = torch.load('../RETFound_mae_meh.pth', map_location='cpu')
        ...
        msg = global_model.load_state_dict(checkpoint_model, strict=False)

        trunc_normal_(global_model.head.weight, std=2e-5)
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        if score_this>score:
            ...
            torch.save(global_model.state_dict(), '../output_print/global_model_resnet.pth')
